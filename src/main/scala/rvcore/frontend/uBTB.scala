  ...
  with MicroBTBParams with HasPerfEvents
{
  ...
  RVCOREPerfAccumulate("ubtb_resp_invalid_by_update", io.s1_fire && lastCycleHasUpdate && shouldNotFallThru)
  RVCOREPerfAccumulate("ubtb_resp_invalid_by_ftpred", io.s1_fire && !lastCycleHasUpdate && !shouldNotFallThru)
