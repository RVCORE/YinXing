...
import utils._
import rvcore.backend.fu.PMPReqBundle
import rvcore.cache.mmu.{BlockTlbRequestIO, TlbReq}
...
abstract class ICacheBundle(implicit p: Parameters) extends RVCOREBundle
  with HasICacheParameters

abstract class ICacheModule(implicit p: Parameters) extends RVCOREModule
  with HasICacheParameters

abstract class ICacheArray(implicit p: Parameters) extends RVCOREModule
  with HasICacheParameters
