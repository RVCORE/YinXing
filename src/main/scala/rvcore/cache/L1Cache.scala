...
import rvcore.{HasRVCOREParameter, RVCOREBundle, RVCOREModule}
...
trait HasL1CacheParameters extends HasRVCOREParameter
...
abstract class L1CacheModule(implicit p: Parameters) extends RVCOREModule
  with HasL1CacheParameters

abstract class L1CacheBundle(implicit p: Parameters) extends RVCOREBundle
  with HasL1CacheParameters
