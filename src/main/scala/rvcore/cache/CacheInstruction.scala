...
abstract class CacheCtrlModule(implicit p: Parameters) extends RVCOREModule with HasCSRConst with CacheControlConst
...
class CacheCtrlReqInfo(implicit p: Parameters) extends RVCOREBundle with CacheControlConst {
...
class CacheCtrlRespInfo(implicit p: Parameters) extends RVCOREBundle with HasICacheParameters with CacheControlConst{
