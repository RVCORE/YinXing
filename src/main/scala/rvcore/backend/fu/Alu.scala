...
class AddModule(implicit p: Parameters) extends RVCOREModule {
...
class SubModule(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
    val src = Vec(2, Input(UInt(XLEN.W)))
...
class LeftShiftModule(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
...
class LeftShiftWordModule(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
...
class RightShiftModule(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
    val shamt = Input(UInt(6.W))
    val revShamt = Input(UInt(6.W))
...
class RightShiftWordModule(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
    val shamt = Input(UInt(5.W))
    val revShamt = Input(UInt(5.W))
...
class MiscResultSelect(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
...
class ShiftResultSelect(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
...
class WordResultSelect(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
    val func = Input(UInt())
...
class AluResSel(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
...
class AluDataModule(implicit p: Parameters) extends RVCOREModule {
  val io = IO(new Bundle() {
    val src = Vec(2, Input(UInt(XLEN.W)))
