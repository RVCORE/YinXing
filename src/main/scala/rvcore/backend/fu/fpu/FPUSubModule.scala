...
import rvcore.{FPUCtrlSignals, RVCOREModule}
import rvcore.backend.fu.{FunctionUnit, HasPipelineReg}
...
abstract class FPUDataModule(implicit p: Parameters) extends RVCOREModule {
