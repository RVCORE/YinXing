...
trait RVCOREModule extends ScalaModule with PublishModule {
  ...
  def pomSettings = PomSettings(
    description = "YinXing",
    organization = "",
    url = "https://github.com/RVCORE/YinXing",
    licenses = Seq(License.`Apache-2.0`),
    versionControl = VersionControl.github("RVCORE", "YinXing"),
...
object huancun extends RVCOREModule with SbtModule {
...
object difftest extends RVCOREModule with SbtModule {
  override def millSourcePath = os.pwd / "difftest"
}

object fudian extends RVCOREModule with SbtModule

// extends this trait to use YinXing in other projects
trait CommonYinXing extends RVCOREModule with SbtModule { m =>
...
object YinXing extends CommonYinXing {
